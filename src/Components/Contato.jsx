...
const Contato = () => {
  return (
    <section className="text-center mb-12">
      <h1 className="font-alice text-5xl mb-[40px]">Contato</h1>
      <div className="flex justify-center items-center gap-[120px]">
        ...
        <div className="flex flex-col gap-6 text-start">
          ...
          <div className="border-b-2 border-b-border-color">
            <h3 className="text-xl font-bold text-blue-text">Email & Telefone</h3>
            <p className="text-blue-text">contato@fishplace.com</p>
            <p className="mb-[10px] text-blue-text">+1 99999-9999</p>
          </div>
          <div>
            <h3 className=" flex items-center gap-2 text-xl font-bold text-blue-text before:content-[''] before:border-2 before:border-zinc-900 before:bg-red-500 before:rounded-full before:w-2 before:h-2 before:inline-block">Horário</h3>
